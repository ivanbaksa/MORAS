class Parser:
    ...
    def _parseLine(self, line, n):
        ...
        if l[0] == "push":
            if len(l) == 3 and l[2].isnumeric(): #1.a) ZAD ZADACA  samo dodano l[2].isnumeric[]//////////////////////////////
                return "//" + " ".join(l) + "\n" + self._push(l[1], l[2], n)
            else:
                self._flag = False
                Parser._error("Parser", n, "Undefined command, 1.a)zad");
                return ""
            ...
            if l[0] == "label" and len(l) == 2:
                ...
                if self._func + "$" + l[1] in self._labels:  #1.b) ZAD  provjerava jel se label nakoji goto pokusava ici vec prije pojavio
                    return "//" + " ".join(l) + "\n" + self._goto(l[1], n)
                else:
                    self._flag = False
                    Parser._error("Parser", n, " nema tog labela, 1.b)zad");
                    return ""
